...
public class GoogleMapActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sourceLat = bundle.getString("sourceLat");
        sourceLng = bundle.getString("sourceLng");
        destinationLat = bundle.getString("destinationLat");
        destinationLng = bundle.getString("destinationLng");

        System.out.println("Controller in the ON Create  received data:"+destinationLat+" "+destinationLng);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        System.out.println("console in onConnected ()!!!!!"+destinationLat+" "+destinationLng);
        ...
        if (mLastLocation != null) {
            ...
            mMap.addMarker(new MarkerOptions().position(new LatLng(currentLat,currentLng)).title("Current Location"));
            mMap.addMarker(new MarkerOptions().position(new LatLng(Double.parseDouble(sourceLat),Double.parseDouble(sourceLng))).title("Source Location"));
            mMap.addMarker(new MarkerOptions().position(new LatLng(Double.parseDouble(destinationLat),Double.parseDouble(destinationLng))).title("Destination Location"));
            new RamAsyncTask(GoogleMapActivity.this){

                @Override
                public void process() {
                    URL url= null;
                    try {
                        System.out.println("points came in onconnected!!!!!"+sourceLat+" "+" "+sourceLng+" "+destinationLat+" "+destinationLng);
                        url = new URL("http://maps.googleapis.com/maps/api/directions/json?origin="+sourceLat+","+sourceLng+"&destination="+destinationLat+","+destinationLng);
